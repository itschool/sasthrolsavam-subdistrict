<?php
class School_Master_Model extends CI_Model{
	...
	{
		$rev_district_code			=	($this->session->userdata('USER_GROUP') == 'W') ? $this->input->post('cmbDistrict'): $this->session->userdata('DISTRICT_CODE');	
		$edu_district_code			=	($this->session->userdata('USER_TYPE') == 2 || $this->session->userdata('USER_TYPE') == 1 ) ? $this->input->post('cmbEduDistrict'): $this->session->userdata('EDU_DISTRICT');
		$sub_district_code			=	($this->session->userdata('USER_TYPE') == 2 || $this->session->userdata('USER_TYPE') == 1 ) ? $this->input->post('cmbSubDistrict'): $this->session->userdata('SUB_DISTRICT');
		...
		$schooldetails_data['school_code']		=	$school_code;	
		$this->db->insert('school_details',$schooldetails_data);
	...
	function exist_school_details()
	{
		if($this->session->userdata('USER_TYPE') == 1){
			...
			if ($this->session->userdata('DISTRICT_CODE'))
			{
				$this->db->where('rev_district_code', $this->session->userdata('DISTRICT_CODE'));
			}
