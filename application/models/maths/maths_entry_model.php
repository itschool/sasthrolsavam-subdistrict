...
class Maths_entry_Model extends CI_Model{
	function Maths_entry_Model()
	{
		parent::__construct();
	}
	...
	function save_maths_details($schoolcode,$category,$fairid,$item_details){
		...
		for($i=0;$i<$item_count;$i++)
		{
			...
			$data=array();
				...
				if($item_code[$i]==138 || $item_code[$i]==147 || $item_code[$i]==164 || $item_code[$i]==182)
				{
					$name_magazine	=	'name_magazine'.$item_code[$i].$k;
					$data['exhibit_name']				=	$this->input->post($name_magazine);
				}
			 ...
			 $admn_no=$admn_category.$adno;
				...
				if($data['item_code'] == 138 || $data['item_code'] == 147 || $data['item_code'] == 164 || $data['item_code'] == 182)//if maths magazine
				{
				//echo '<br>school_code=='.$data['school_code'].'--item_code=='.$data['item_code'].'<br>';
				...
				{
				//echo '<br>school_code=='.$data['school_code'].'--admn_no=='.$data['admn_no'].'<br>';
				...
				//echo '<br><br>';print_r($schoolcode_admn_dtls);
	...
	{//echo '<br>pa=='.$partid.'<br>';
	//echo '<br><br><br>';
	//	print_r($data);if(((($data['item_code'] == 139) || ($data['item_code'] == 147) || ($data['item_code'] == 164) ) && ($data['exhibit_name']<>'')) || ($data['admn_no']>0))//if maths magazine
			//echo '<br>pa=='.$partid.'<br>';
	//echo '<br><br><br>';
   //print_r($data);
			...
			//echo '<br><br><br>'.$data['admn_no'];		
			if((($data['item_code'] == 138 || $data['item_code'] == 147 || $data['item_code'] == 164 || $data['item_code'] == 182)  && $data['exhibit_name'] != '')  || ($admn_flag > 0))
			{	
				if($partid > 0)
				{
