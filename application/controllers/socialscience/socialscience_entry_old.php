<?php
class Socialscience_entry extends CI_Controller{ 
	function Socialscience_entry()
	{
		parent::__construct(); 
	...
	{		
		...
		{
			$socialscience_details						=	 $this->Socialscience_Model->save_socialscience_details($schoolcode,$category,$fairid,$this->Content['item_details']);
		}
		
		$this->template->write_view('content','socialscience/socialscience_entry');
		$this->template->load();
