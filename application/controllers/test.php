...
class Test extends CI_Controller {
   ...
   echo $url;*/
		...
		$this->fpdf->Output('Cordinates_Portrait.pdf','I');
   ...
   echo $url;*/
		...
		$this->fpdf->Output('Cordinates_Landscape.pdf','I');
	...
	function notemplate($fair)
	{
		...
		$this->fpdf->SetFont('Arial','B',18);
		$this->fpdf->SetY(30);
		$this->fpdf->Cell(350,100,'Please set Template for '.$fairname);
		$this->fpdf->Output('output.pdf','I');  
		
	}
	
	function no_partTemplate($fair)
	{
		if($fair==1)
			$fairname	=	'Science Fair';
		else if($fair==2)
		...
		$this->fpdf->SetFont('Arial','B',18);
		$this->fpdf->SetY(30);
		$this->fpdf->Cell(350,100,'Please set Participants Template for '.$fairname);
		$this->fpdf->Output('output.pdf','I');  
