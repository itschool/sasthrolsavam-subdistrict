...
class User_Registration extends CI_Controller {
	...
	function index()
	{
	//	echo '<br><br><Br>errrrrrrr';
		$this->Content['user_rights']	=	$this->User_Registration_Model->get_user_rights();
		$this->Content['fair']							=	$this->General_Model->prepare_select_box_data('science_master','fairId,fairName','','Select Fair','fairId');
	...
	{
	//$perm =$this->Session_Model->check_user_permissions(1);
