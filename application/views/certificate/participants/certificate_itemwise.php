...
<h3>Participartion Certificate Participant Wise</h3>
</div>
<br />
<div class="container">
<?php echo form_open('certificate/certificate/get_attended_certificate_pdf', array('id' => 'formIRL'));
?>
<input type="hidden" name="hidUservalue" id="hidUservalue"  value="SHOW" />
<input type="hidden" name="hidItemId" id="hidItemId"  value="<?php echo $item_id; ?>" />
