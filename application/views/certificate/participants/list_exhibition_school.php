...
<table width="100%" border="0" cellspacing="0" cellpadding="6" align="center" class="heading_tab" style="margin-top:15px;">
 ...
 <?php
	...
	?>
		<tr>
			...
			<td width="27%" class="table_row_first">
				&nbsp;&nbsp;
				<a href="javascript:void(0)" onClick="javascript:get_attendedExhibitionCaptains(<?php echo $school_details[$j]['school_code'];?>)">
	...
	?>
    <tr>
			<td class="table_row_first" colspan="5" align="left">&nbsp;&nbsp;<a href="javascript:void(0)" onClick="javascript:get_attendedExhibitionCaptains('all')">
				All School</a></td>
		</tr>
</table>
