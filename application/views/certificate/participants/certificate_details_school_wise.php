...
<table width="100%" border="0" cellspacing="0" cellpadding="6" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;Participant Certificate - School Wise: 
	...
	?>
		<tr>
			...
			<td width="27%" class="table_row_first">
				&nbsp;&nbsp;
				<a href="javascript:void(0)" onClick="javascript:getSchoolWise_attendedCertificate(<?php echo $school_details[$j]['school_code'];?>)">
