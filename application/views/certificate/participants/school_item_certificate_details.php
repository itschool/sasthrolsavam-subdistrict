...
<h3>Participantion Certificate School Wise</h3>
</div>
<br/>
<div class="container">
<?php echo form_open('certificate/certificate/get_attended_certificate_pdf_school_wise', array('id' => 'formIRL'));
...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <?php if(is_array(@$fair) and (count(@$fair) >0)){?>
   <tr>
    ...
    <td align="left" width="40%" class="table_row_first"><?php 
...
?>
    ...
    <td width="27%" class="table_row_first">
          ...
          <input type="radio" name="radioLabel" value="spot" id="radioLabel_spot"  checked="checked">On the Spot
            ...
            <input type="radio" name="radioLabel" value="spot" id="radioLabel_spot"  onClick="selectCat_certificate(this.value)" checked="checked">
            On the Spot
            </div>
    <?php }?>
   </td>
