...
<h3><?php if(@$fairId==1){ echo 'Science Fair Certificate Template';}else if(@$fairId==2){ echo 'Mathematics Fair Certificate Template';}else if(@$fairId==3){ echo 'Social Science Fair Certificate Template';}else if(@$fairId==4){ echo 'Work Experience Fair Certificate Template';}else{ echo 'IT Fair Certificate Template';}?></h3>
</div>
<br />
