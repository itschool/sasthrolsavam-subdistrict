...
<h3>Exhibition Certificate School Wise</h3>
</div>
<br/>
<div class="container">
...
<table width="100%" border="0" cellspacing="0" cellpadding="6" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp; Certificate - School Wise<th align="right">Print&nbsp;&nbsp;<img src="<?php echo base_url(false).'images/print_icon.png';?>" title="print" class="window_print" 
 ...
 //echo '<br><br>';print_r($_POST);
	...
	?><input type="hidden" name="fest" id="fest" />
		<tr>
			...
			<td width="27%" class="table_row_first">
				&nbsp;&nbsp;
				<a href="javascript:void(0)" onClick="javascript:getExhibitionCaptains(<?php echo $school_details[$j]['school_code'];?>,<?php echo @$_POST['cmbFestType']?>)">
	...
	?>
    <tr>
			<td class="table_row_first" colspan="5" align="left">&nbsp;&nbsp;<a href="javascript:void(0)" onClick="javascript:getExhibitionCaptains('all')">
				All School</a></td>
		</tr>
</table>
