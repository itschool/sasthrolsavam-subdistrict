...
-->
    ...
    <tr>
    <td align="center"><span class="style1">IT Fair </span></td>
    </tr>
    </table><br />
...
?>
  <tr style="border-top:1px solid #CFCFCF;" bgcolor="<? echo $color; ?>" >
	...
	<td align="left" ><a href="<?php echo base_url();?>index.php/IT/IT_entry/it_school_entry/<?php echo $value['school_code']?>"><?php echo ($value['school_code']); ?></a></td>
    <td align="left" ><a href="<?php echo base_url();?>index.php/IT/IT_entry/it_school_entry/<?php echo $value['school_code']?>"><?php echo ($value['school_name']); ?></a></td>
