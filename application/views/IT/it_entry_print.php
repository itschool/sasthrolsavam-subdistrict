...
<?php
 echo form_open('school/registration/maths_print_details', array('id' => 'itprint','name' => 'itprint'));
     ...
     <tr>
       <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#EAEAF4" style="border:solid 1px; color:#999999">
         ...
         <tr class="table_row_first">
           <td width="23%" height="30" bgcolor="#E9E9D1" class="style7">Number of Boys Participated&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;<? echo $this->Registration_Model->fair_count($fairid,@$schoolcode,'B');?></td>
           <td colspan="2" bgcolor="#E9E9D1" class="style4"><span class="style7">Number of Girls Participated&nbsp;&nbsp;&nbsp;:&nbsp;</span>&nbsp;&nbsp;<span class="style7"><? echo $this->Registration_Model->fair_count($fairid,@$schoolcode,'G');?></span></td>
           </tr>
         <tr class="table_row_first">
