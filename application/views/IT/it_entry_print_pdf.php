...
<page_footer>
        ...
        <tr>
          <td colspan="3" align="left"> <?php 
			   echo " Report confirmed on ".$school_details[0]['it_confirmTime'];
     ...
     <tr>
       <td><table border="1" cellspacing="0" cellpadding="4" align="center"  style=" width:100%; border:solid 1px #000000;">
         ...
         <td height="15" bgcolor="#FFFFFF"  style="width:6%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Slno</strong></span></td>
           ...
           <td height="15" bgcolor="#FFFFFF" style="width:20%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px; text-align:left"><span class="style1"><strong>Admn No</strong></span></td>
    ...
    <tr>
     ...
     <tr>
       <td><table border="1" cellspacing="0"  align="center"  style=" width:100%; border:solid 1px #000000;">
         ...
         <tr>
          <td height="15" bgcolor="#FFFFFF"  style="width:6%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Slno</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:31%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Items</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:30%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Name of Participant</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:8%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Std</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:20%; text-align:left;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Admn No</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:8%;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Gender</strong></span></td>
         </tr>
         <?php 
...
?>
         <tr <?php if($j%2==0) {?>class="table_row_second" <?php } else?>class="table_row_first">
           ...
           <?php }?>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF"  style="width:31%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper($item_name[$j]);?>
     ...
     <td height="30" bgcolor="#FFFFFF" style="width:8%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style2"><strong>Type</strong></span></td>
           <td height="30" bgcolor="#FFFFFF" style="width:13%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Admn No</strong></span></td>
...
?>
		 ...
		 @$admn_fest="";
           ...
           <td height="25" bgcolor="#FFFFFF" style="width:12%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php  
		   if(@$part_item_details_hss[$r]['item_code']==$item_code[$j]){ echo @$part_item_details_hss[$r]['admn_no'];} ?></td>
           <td height="25" bgcolor="#FFFFFF" style="width:8%;border-top: solid 1px #000000; padding:2px"><?php 
