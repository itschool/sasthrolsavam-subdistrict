...
<page_header>
		...
		<table style="width: 100%;">
			<tr>
			    ...
			    SOCIAL SCIENCE FAIR 2013-14<br />
				</strong></td>
		  </tr>
            <tr>
...
?>
         ...
         <tr>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:5%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style5"><?php echo $slno;?></span></td>
           <?php }?>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:22%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper(@$part_item_details_lp[$r]['item_name']);?>
           <input name="item_code<?php echo $item_code[$j];?>" type="hidden" value="<?php echo $item_code[$j]; ?>" /></td><?php }?>
            
			<?php if($spn==0) {?><td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:17%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php if(@$part_item_details_lp[$r]['exhibit_name']!='0'){echo  @$part_item_details_lp[$r]['exhibit_name']; }else { echo "-"; }?></td>
           <?php }?>
           <td height="15" bgcolor="#FFFFFF" style="width:25%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px">
               <?php 
		   
		  /* if(@$part_item_details_lp[$r]['item_code']==$item_code[$j])*/{echo @$part_item_details_lp[$r]['participant_name'];}
		   ?></td>
           <td height="15" bgcolor="#FFFFFF"  style="width:8%;border-right:1px #000000; padding:2px; text-align:center;border-top: solid 1px #000000; padding:2px"><?php 
		  /* if(@$part_item_details_lp[$r]['item_code']==$item_code[$j])*/{echo  @$part_item_details_lp[$r]['class']; }?></td>
          
         
           <td height="15" bgcolor="#FFFFFF" style="width:18%;border-right:1px #000000; padding:2px; text-align:left;border-top: solid 1px #000000; padding:2px"><?php  
