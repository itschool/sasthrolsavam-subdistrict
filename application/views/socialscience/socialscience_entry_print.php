...
<div class="conthead" align="center">
  <h2><em>SOCIAL SCIENCE FAIR</em></h2>
</div>
<?php
 echo form_open('school/registration/maths_print_details', array('id' => 'socialscienceprint','name' => 'socialscienceprint'));
   ...
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="color:#999999" bgcolor="#FFFFF0"><tr><td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" style="border:solid 1px; color:#999999" bgcolor="#E9E9D1">
     ...
     <tr>
       <td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
         <tr>
           <td colspan="8" bgcolor="#D9D9EC"><div align="center" class="style4"><strong>LOWER PRIMARY DETAILS</strong></div></td>
           </tr>
         <tr>
           ...
           <td width="18%" bgcolor="#E9E9D1"><span class="style1">&nbsp;Name of Exhibit</span></td>
...
?>
     ...
     <tr>
       <td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
         <tr>
           <td colspan="8" bgcolor="#D9D9EC"><div align="center" class="style4"><strong>UPPER PRIMARY DETAILS</strong></div></td>
         </tr>
         <tr>
           <td width="4%" bgcolor="#E9E9D1"><div align="center"><span class="style1">Slno</span></div></td>
           <td width="18%" bgcolor="#E9E9D1"><span class="style1">&nbsp;Items</span></td>
...
?>
     ...
     <tr>
       <td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
         <tr>
           <td colspan="8" bgcolor="#D9D9EC"><div align="center" class="style4"><strong>HS DETAILS</strong></div></td>
         </tr>
         <tr>
           <td width="4%" bgcolor="#E9E9D1"><div align="center"><span class="style1">Slno</span></div></td>
           <td width="18%" bgcolor="#E9E9D1"><span class="style1">&nbsp;Items</span></td>
...
?>
     ...
     <tr>
       <td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
         <tr>
           <td colspan="9" bgcolor="#D9D9EC"><div align="center" class="style4"><strong>HSS/VHSS DETAILS</strong></div></td>
         </tr>
         <tr>
           <td width="4%" bgcolor="#E9E9D1"><div align="center"><span class="style1">Slno</span></div></td>
           <td width="18%" bgcolor="#E9E9D1"><span class="style1">&nbsp;Items</span></td>
