...
-->
    ...
    <tr>
    <td align="center"><span class="style1">Social Science Fair </span></td>
    </tr>
    </table><br />
...
foreach(@$details as $value)
	{
	//echo '<br><br><br>------------'.$values;
			$color = ($i % 2 == 0) ? '#E6F0DD' : '';
		
?>
  <tr style="border-top:1px solid #CFCFCF;" bgcolor="<? echo $color; ?>" >
    <td align="center" ><?php echo $i; ?></td>
	<td align="left" ><a href="<?php echo base_url();?>index.php/socialscience/socialscience_entry/socialscience_school_entry/<?php echo $value['school_code']?>"><?php echo ($value['school_code']); ?></a></td>
    <td align="left" ><a href="<?php echo base_url();?>index.php/socialscience/socialscience_entry/socialscience_school_entry/<?php echo $value['school_code']?>"><?php echo ($value['school_name']); ?></a></td>
