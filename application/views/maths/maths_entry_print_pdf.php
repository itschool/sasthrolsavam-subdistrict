...
<page_footer>
        ...
        <tr>
          <td colspan="3" align="left"> <?php 
			   echo " Report confirmed on ".$school_details[0]['maths_confirmTime'];
...
?>
         ...
         <tr <?php if($j%2==0) {?> <?php } ?>>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:6%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style5"><?php echo $slno;?></span></td>
           <?php }?>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:30%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper(@$part_item_details_lp[$r]['item_name']);?>
		   ...
		   {
		   ?>
            <td height="15" colspan="4" bgcolor="#FFFFFF" style="width:30%;border-right:0px #000000; padding:2px;border-top: solid 1px #000000; padding:2px">
           ...
           <td height="15" bgcolor="#FFFFFF" style="width:30%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px">
               <?php 
		  ...
		  /* if(@$part_item_details_lp[$r]['item_code']==$item_code[$j])*/{echo  @$part_item_details_lp[$r]['class']; }?></td>
           ...
           <td height="15" bgcolor="#FFFFFF" style="width:20%;border-right:1px #000000; padding:2px; text-align:left;border-top: solid 1px #000000; padding:2px"><?php  
	...
	$r=0;
	  ...
	  $k=$max_participants[$j];
?>
         <tr <?php if($j%2==0) {?> <?php } else?>>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:6%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style5"><?php echo $slno;?></span></td>
           <?php }?>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:30%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper($item_name[$j]);?>
		   ...
		   ?>
			...
			?>
           <td height="15" bgcolor="#FFFFFF" style="width:30%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php 
           ...
           <td height="15" bgcolor="#FFFFFF" style="width:20%; text-align:left;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php  
...
?>
         <tr <?php if($j%2==0) {?> <?php } else?>>
           ...
           <?php }?>
           <?php if($spn==0) {?>
           <td height="20" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:32%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper($item_name[$j]);?>
           ...
           <td height="20" bgcolor="#FFFFFF" style="width:27%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php 
		 ...
		 @$admn_fest="";
           ...
           <td height="20" bgcolor="#FFFFFF" style="width:13%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php  
