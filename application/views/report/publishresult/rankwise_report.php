...
<table width="77%" border="0" cellspacing="0" cellpadding="0" align="center" >
	<tr>
		...
		<?php echo $value['fairName']; if($value['fairName']=='Work Experience Fair' ){ if($value['fest_name']=='Exhibition' || $value['fest_name']==2){ echo ' (Exhibition)';} else{ echo ' (On the spot)';}}?><br />Rank  Wise Participants Details&nbsp;<?php if($value['fest_name']!='Exhibition' && $value['fest_name']!=2){echo $value['fest_name']; } ?> </td>
  </tr>
</table>
	 ...
	 <table width="93%" align="center" border="1" cellpadding="0" cellspacing="0" >
       ...
       <? } ?>
            ...
            <td width="36" height="25" align="center" class="style3" style=" border-bottom:1px #000000; border-right:1px #000000; padding:2px;">Grade</td>
             <td width="34" height="25" align="center" class="style3" style=" border-bottom:1px #000000; border-right:0px #000000; padding:2px;"><?php if($value['fairName']=='Work Experience Fair' )echo 'Total Mark';else echo 'Point';?></td>
      		<td></td>
       </tr>
		<? 
		}
        ...
        ?>
           ...
           <td width="164" class="style3" align="left" style="border-bottom:1px #000000; border-right:1px #000000; padding:2px;">&nbsp;<?php echo $value['item_code'].' - '.$value['item_name']; ?></td>
            ...
            <td width="208" class="style3" align="left" style="border-bottom:1px #000000; border-right:1px #000000; padding:2px;">&nbsp;&nbsp;<?php echo wordwrap($value['school_code'].' - '.$value['school_name'],50,'<br>');   ?></td>
