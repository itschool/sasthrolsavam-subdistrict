...
<table width="80%" align="center" border="1" style=" border-top:1px black; border-left:1px black; border-right:1px black;" cellpadding="0" cellspacing="0">
		<tr bgcolor="#C6D6EA">
		  <td colspan="8" align="center" height="27" class="style1"><?php echo $details[0]['fairName'];if($details[0]['fairName']=='Work Experience Fair'){ if(@$wrk=='exb'){ echo ' (Exhibition) ';} else{ echo ' (On the Spot) ';}} ?></td>
		</tr>
