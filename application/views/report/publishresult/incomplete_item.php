...
<tr>
    	<td bordercolor="#000000" colspan="7" align="center" class="style1" height="30" style=" border-top:1px black; border-left:1px black; border-right:1px black;" bgcolor="#999900">Items to be Finished in <?php echo $totitem[0]['fest_name']; ?> ( <? echo $fairname[0]['fairName']; ?> )</td>
        </tr>	
  <tr bgcolor="#A8B470">
        <td  height="27" align="center" class="style5">Item </td> 
         <td height="27" align="center" class="style5">Venue</td>
      ...
      <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <td height="27" align="center"><?php echo $value['ground_name']; ?></td>
