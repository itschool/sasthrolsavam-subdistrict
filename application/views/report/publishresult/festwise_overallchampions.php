...
<body bgcolor="#F5F5F5" topmargin="0">
  ...
  <table width="80%" align="center" border="1" style=" border-top:1px black; border-left:1px black; border-right:1px black;" cellpadding="0" cellspacing="0">
	...
	<tr bgcolor="#B689B1">
			...
			if($value['fairName']=='Work Experience Fair'){ if(@$wrk=='exb'){ echo ' (Exhibition) ';} elseif(@$wrk=='all'){ echo ' ';} else{ echo ' (On the Spot) ';}} ?> 
			<?php //}?></td>
	</tr>
    <tr bgcolor="#006699">
        	<td colspan="8" align="center" height="30" class="style2">
            &nbsp;&nbsp; <?php echo $value['fest_name'];  ?>&nbsp;&nbsp;Overall Champion
			<?php ?></td>
	</tr>
 <tr> 
