...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  <tr>
   ...
   <tr>
    <td width="4%" class="">&nbsp;</td>
    <td align="left" width="22%" class="table_row_first">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select Fair : </td>
    <td align="left" width="74%" class="table_row_first"><?php echo form_dropdown("cmbFairType",$fair,@$selected_fair_id, 'class="input_box" id="cmbFairType" ');?></td>
