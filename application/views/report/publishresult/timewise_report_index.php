...
<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
  ...
  <tr>
    <td width="4%" class="">&nbsp;</td>
    <td align="left" width="25%" class="table_row_first">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select Fair : </td>
    <td colspan="3" align="left" class="table_row_first"><?php echo form_dropdown("cmbFairType",$fair,@$selected_fair_id, 'class="input_box" id="cmbFairType" ');?></td>
    </tr>
  <tr>
    <td width="4%" class="">&nbsp;</td>
	...
	echo form_dropdown('txtfromampm',$ampm_array_from,'','id="txtfromampm"');?>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
	...
	echo form_dropdown('txttoampm',$ampm_array_to,'','id="txttoampm"');?>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    ...
    <td align="left" width="18%" class="table_row_first"><form name="form1" method="post" action="">
      <label>
      <input type="submit" name="btnSubmit" id="btnSubmit" value="View report" onclick="return funschoolwisepoint();">
      </label>
    </form>    </td>
