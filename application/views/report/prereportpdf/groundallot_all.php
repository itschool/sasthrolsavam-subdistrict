...
<page backtop="37mm" backbottom="20mm ">
	<page_header>
        ...
        <tr>
        <td height="31" align="center" class="style1" valign="top">Number of Participants and duration for venue allotment<br /><?php echo $allot[$j]['fest_name']; ?></td>
        </tr>  
</table>
	</page_header>
<page_footer>
 ...
 <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" >
  <tr>
  <td width="50"  align="center"  class="tb" style="border-right:1px #666666; padding:2px;" >Sl.No.</td>
    ...
    <td width="100" align="left" class="tb" style="border-right:1px #666666; padding:2px;">Time for completion</td>
    <td width="60" align="center" class="tb" style="border-right:1px #666666; padding:2px;">Venue</td>
    <td width="60" align="center" class="tb" style="border-right:0px #666666; padding:2px;">Date Time</td>
   </tr>
		<?php
		}
		$count++;
