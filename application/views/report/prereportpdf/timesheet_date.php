...
<page backtop="45mm" backbottom="20mm ">
	<page_header>
        ...
        <table width="100%" border="0">
        	<tr>
            	<td align="center" width="250" class="style2">Venue : <?php echo @$itemtime[0]['ground_name'].' on   '.datetophpmodel(@$itemtime[0]['item_date']);?></td>
                <td align="center" width="250" class="style2">Max Time : <?php $time_type = (@$itemtime[0]['time_type'] == 'M') ? 'Min' : 'Sec'; echo @$itemtime[0]['max_time'].' '.@$time_type; ?></td>
            </tr>
