...
<tr>
    	<td align="center" class="style1" height="27" width="800"><?php echo $fair_name; if($fair_name=='Work Experience Fair' && $this->input->post('radioLabel') == 'exhib'){ echo ' (Exhibition)';} if($fair_name=='Work Experience Fair' && $this->input->post('radioLabel') == 'spot'){ echo ' (On the Spot)';} ?></td>
    </tr>
    <tr>
