	...
	<page_header>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
            ...
            <tr>
				...
				<br />Itemwise participants list</td>
            </tr>
             <tr>
        <td class="tb" align="left">Item  :&nbsp;&nbsp;
        <?php echo @$itemdet[0]['item_code'];?>&nbsp;-&nbsp;<?php echo @$itemdet[0]['item_name'];?>&nbsp;&nbsp;</td>
        <td class="tb" align="left">&nbsp;&nbsp;<?php  if(@$festdet[0]['fest_name']!='Exhibition'){ echo 'Festival : '.@$festdet[0]['fest_name'];}?></td>
  </tr>
        </table>
	</page_header>
<page_footer>
