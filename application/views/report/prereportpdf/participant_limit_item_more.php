...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
    <tr>
        <td height="43" align="center" class="style1"><?php echo $fair_name; ?><br />List of Students Participating More than One Items</td>
    </tr>
</table>
...
<table width="245%" align="center" border="1" cellpadding="0" cellspacing="0" >
    ...
    <tr>
        ...
        <td width="55" align="center" class="style3" style="border-right:1px #666666; padding:2px;">No.&nbsp;of&nbsp;Items</td>
        <td width="100" align="left" class="style3" style="border-right:1px #666666; padding:2px;">&nbsp;Name </td>
        <td width="100" align="left" class="style3" style="border-right:1px #666666; padding:2px;">School(Subdistrict)</td>
        <td width="150" align="left" class="style3" style="border-right:1px #666666; padding:2px;">Items</td>
    </tr>
    <? 
    } 
    ?>
    <tr>
        ...
        <td class="ety"  align="left"  style="border-top:1px #666666; border-right:1px #666666; padding:2px;"><?php echo wordwrap($fees_details[$j]['school_code'].' - '.$fees_details[$j]['school_name'].'('.$fees_details[$j]['sub_district_name'].')',40,'<br>'); ?></td>
        
         <td class="ety"  align="left"  style="border-top:1px #666666; border-right:1px #666666; padding:2px;">
        <?
        $item_details		=	$this->prereport_model->get_participant_details_more_allfair($fees_details[$j]['participant_id'],$fair_id);
        ...
        <?php echo wordwrap($item_name,25,'<br>').' ('.$item_code.')<br />'; 
		 }        
        ?>
    </td>    
