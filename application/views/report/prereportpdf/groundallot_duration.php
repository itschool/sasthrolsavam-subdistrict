...
<table width="123%" border="0" cellspacing="0" cellpadding="4" align="center" class="heading_tab" style="margin-top:15px;">
        <tr>
        <td height="31" align="center" class="style1" valign="top">Number of Participants and duration for venue allotment<br /><?php echo $allot[0]['fest_name']; ?></td>
        </tr>  
</table>
 <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" >
  ...
  <td width="30"  align="center"  class="tb" style="border-right:1px #666666; padding:2px;" >Sl.No.</td>
    ...
    <td width="50" align="center" class="tb" style="border-right:1px #666666; padding:2px;" >Time</td>
    <td width="70" align="center" class="tb" style="border-right:1px #666666; padding:2px;" >No. of Participants</td>
    <td width="80" align="left" class="tb" style="border-right:1px #666666; padding:2px;">Time for completion</td>
    <td width="50" align="left" class="tb" style="border-right:1px #666666; padding:2px;">Venue</td>
    <td width="120" align="left" class="tb" style="border-right:0px #666666; padding:2px;">Date Time</td>
   </tr>
		<?php
			  $count	=	0;
