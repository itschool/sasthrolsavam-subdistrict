...
<page_header>
        ...
        <tr>
            <td  align="left" width="305" class="style1"  style=" padding:2px;"height="25">&nbsp;&nbsp; <?php echo $festresult[$j]['item_code'];?>-<?php echo @$festresult[$j]['item_name'];?>(<?php echo  @$festresult[$j]['fest_name'];?>)  </td>
            <td  align="right" width="438" class="style1"  style=" padding:2px;"height="25">
               <?php echo @$festresult[$j]['ground_name'].' on '.datetophpmodel(@$festresult[$j]['start_time']);	 ?>            </td>
        </tr>
         </table> 
  </page_header>
<page_footer>
	...
	?>
          ...
          <tr>
            ...
            <td width=35  height="10"rowspan="2" align="center"style='border:0 0 0.5px 0.5px 0 #666666 ; '>Code No</td>
            ...
            <td align="center" colspan="<?php echo $ctt+1; ?>" width=20  height="10"style='border:0 0 0.5px 0.5px 0 #666666; '>Marks</td>       <td align="center" rowspan="2" width=20 height="10" style='border:0 0 0.5px 0.5px 0 #666666 ; '> %</td>
            ...
            <td align="center" rowspan="2" width=20  height="10"style='border:0 0 0.5px 0.5px 0 #666666 ; '><?php if($fairname[0]['fairName']=='Work Experience Fair')echo 'T'; else echo 'P';?></td>
          </tr>
          <tr>
          <?php
		  ...
		  ?>
            ...
            <td  align="center" height="10"width=20 style='border:0 0 0.5px 0.5px 0 #666666 ;'><?php echo $k+1;?></td>
           <?php  } ?>
...
<?php 
          ...
          <td align="center" width=20 class="style3"><?php if($fairname[0]['fairName']=='Work Experience Fair')echo $festresult[$j]['total_mark']; else echo $festresult[$j]['point'];?></td>
      	</tr>
