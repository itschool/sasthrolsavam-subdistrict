...
<page_footer>
        ...
        <tr>
		  ...
		  echo " Report confirmed on ".$school_details[0]['science_confirmTime'];
...
<table style="width: 100%;">
   ...
   <tr><td><table style="width:100%">
     ...
     <tr >
       <td height="20" bgcolor="#FFFFFF"  >School Phone(with STD code) : </td>
       <td height="20" colspan="5" bgcolor="#FFFFFF"  ><?php echo @$school_details[0]['school_phone']?> </td>
     </tr>
     <tr style="border-bottom:1px solid #666666;">
	...
	<tr>
     ...
     <tr>
       <td><table border="1" cellspacing="0" cellpadding="4" align="center"  style="width:100%; border:solid 1px #000000;">
         <tr>
           <td height="15" colspan="8" bgcolor="#FFFFFF" style="text-align:left"><strong>LP SECTION</strong><br />          </td>
         </tr>
         <tr>
           <td height="20" bgcolor="#FFFFFF"  style="width:5%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><strong>Slno</strong></td>
           <td height="20" bgcolor="#FFFFFF" style="width:22%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><strong>Items</strong></td>
           <td height="20" bgcolor="#FFFFFF" style="width:17%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><strong>Name of Exhibit</strong></td>
           <td height="20" bgcolor="#FFFFFF" style="width:25%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><strong>Name of Participant</strong></td>
           <td height="20" bgcolor="#FFFFFF" style="width:8%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><strong>Std</strong></td>
           <td height="20" bgcolor="#FFFFFF" style="width:18%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px; text-align:left"><strong>Admn Number</strong></td>
           <td height="20" bgcolor="#FFFFFF" style="width:8%;border-top: solid 1px #000000; padding:2px"><strong>Gender</strong></td>
         </tr>
         <?php 
...
?>
         ...
         <tr>
           <?php if($spn==0) {?>
           <td rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:5%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style5"><?php echo $slno;?></span></td>
           <?php }?>
           <?php if($spn==0) {?>
           <td rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:22%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper(@$part_item_details_lp[$r]['item_name']);?>
           <input name="item_code<?php echo $item_code[$j];?>" type="hidden" value="<?php echo $item_code[$j]; ?>" /></td><?php }?>
            
			<?php if($spn==0) {?><td rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:17%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php if(@$part_item_details_lp[$r]['exhibit_name']!='0'){echo  @$part_item_details_lp[$r]['exhibit_name']; }else { echo "-"; }?></td>
           <?php }?>
           <td bgcolor="#FFFFFF" style="width:25%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px">
               <?php 
		   
		  /* if(@$part_item_details_lp[$r]['item_code']==$item_code[$j])*/{echo @$part_item_details_lp[$r]['participant_name'];}
		   ?></td>
           <td bgcolor="#FFFFFF"  style="width:8%;border-right:1px #000000; padding:2px; text-align:center;border-top: solid 1px #000000; padding:2px"><?php 
		  /* if(@$part_item_details_lp[$r]['item_code']==$item_code[$j])*/{echo  @$part_item_details_lp[$r]['class']; }?></td>
          
         
           <td bgcolor="#FFFFFF" style="width:18%;border-right:1px #000000; padding:2px; text-align:left;border-top: solid 1px #000000; padding:2px"><?php  
		  /* if(@$part_item_details_lp[$r]['item_code']==$item_code[$j])*/{ echo @$part_item_details_lp[$r]['admn_no'];} ?></td>
           <td bgcolor="#FFFFFF" style="width:8%; text-align:left;border-top: solid 1px #000000; padding:2px"><?php 
    ...
    <tr>
     ...
     <tr>
       <td><table border="1" cellspacing="0" cellpadding="4" align="center"  style=" width:100%; border:solid 1px #000000;">
         <tr>
           <td height="15" colspan="8" bgcolor="#FFFFFF" style="text-align:left"><strong>UP SECTION</strong></td>
         </tr>
         <tr>
         <td height="15" bgcolor="#FFFFFF"  style="width:5%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Slno</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:22%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Items</strong></span></td>
           <td bgcolor="#FFFFFF" style="width:17%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Name of Exhibit</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:25%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Name of Participant</strong></span></td>
           ...
           <td height="15" bgcolor="#FFFFFF" style="width:18%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px; text-align:left"><span class="style1"><strong>Admn Number</strong></span></td>
...
?>
         <tr>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:5%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style5"><?php echo $slno;?></span></td>
           <?php }?>
           <?php if($spn==0) {?>
           <td height="15" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:22%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper($item_name[$j]);?>
            <input name="item_code<?php echo $item_code[$j];?>2" type="hidden" value="<?php echo $item_code[$j]; ?>" /></td>
          <?php if($spn==0) {?><td rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:17%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php if(@$part_item_details_up[$r]['exhibit_name']!='0'){echo  @$part_item_details_up[$r]['exhibit_name']; }else { echo "-"; }?></td>
           <?php }?>
           <?php }?>
           <td height="15" bgcolor="#FFFFFF" style="width:25%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php 
		   
		   if(@$part_item_details_up[$r]['item_code']==$item_code[$j]){echo @$part_item_details_up[$r]['participant_name'];}
		   ?></td>
           <td height="15" bgcolor="#FFFFFF" style="width:8%; text-align:center;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php 
		   if(@$part_item_details_up[$r]['item_code']==$item_code[$j]){echo  @$part_item_details_up[$r]['class']; }?></td>
           <td height="15" bgcolor="#FFFFFF" style="width:18%; text-align:left;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php  
    ...
    <tr>
     ...
     <tr>
       <td><table border="1" cellspacing="0"  align="center"  style=" width:100%; border:solid 1px #000000;">
         <tr>
           <td height="15" colspan="8" bgcolor="#FFFFFF" style="text-align:left"><strong>HS SECTION<br />
           </strong></td>
         </tr>
         <tr>
          <td height="15" bgcolor="#FFFFFF"  style="width:5%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Slno</strong></span></td>
           ...
           <td height="15" bgcolor="#FFFFFF" style="width:25%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Name of Participant</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:8%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Std</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:18%; text-align:left;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Admn Number</strong></span></td>
           <td height="15" bgcolor="#FFFFFF" style="width:8%;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Gender</strong></span></td>
         </tr>
         <?php 
...
?>
         <tr>
           ...
           <?php if($spn==0) {?><td rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:17%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php if(@$part_item_details_hs[$r]['exhibit_name']!='0'){echo  @$part_item_details_hs[$r]['exhibit_name']; }else { echo "-"; }?></td>
           <?php }?>
           <?php } ?>
     ...
     <tr>
       <td><table border="1" cellspacing="0"  align="center"  style=" width:100%; border:solid 1px #000000;">
         <tr>
           <td height="30" colspan="9" bgcolor="#FFFFFF" style="text-align:left"><strong>HSS/VHSS SECTION</strong></td>
         </tr>
         <tr>
           ...
           <td height="30" bgcolor="#FFFFFF" style="width:22%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Items</strong></span></td>
           <td bgcolor="#FFFFFF" style="width:17%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Name of Exhibit</strong></span></td>
           <td height="30" bgcolor="#FFFFFF" style="width:25%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Name of Participant</strong></span></td>
     ...
     <td height="30" bgcolor="#FFFFFF" style="width:8%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style2"><strong>Type</strong></span></td>
           <td height="30" bgcolor="#FFFFFF" style="width:10%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><span class="style1"><strong>Admn Number</strong></span></td>
...
?>
         <tr>
           <?php if($spn==0) {?>
           <td height="20" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:5%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px" ><span class="style5"><?php echo $slno;?></span></td>
           <?php }?>
           <?php if($spn==0) {?>
           <td height="20" rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:22%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php echo strtoupper($item_name[$j]);?>
            <input name="item_code<?php echo $item_code[$j];?>4" type="hidden" value="<?php echo $item_code[$j]; ?>" /></td>
          <?php if($spn==0) {?><td rowspan="<?php echo $k; ?>" bgcolor="#FFFFFF" style="width:17%;border-right:1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php if(@$part_item_details_hss[$r]['exhibit_name']!='0'){echo  @$part_item_details_hss[$r]['exhibit_name']; }else { echo "-"; }?></td>
           <?php }?>
           <?php }?>
           <td height="20" bgcolor="#FFFFFF" style="width:25%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php 
		   
		   if(@$part_item_details_hss[$r]['item_code']==$item_code[$j]){echo @$part_item_details_hss[$r]['participant_name'];}
		   ?></td>
           <td height="20" bgcolor="#FFFFFF" style="width:8%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php 
		 ...
		 @$admn_fest="";
           ...
           <td height="20" bgcolor="#FFFFFF" style="width:10%;border-right: solid 1px #000000; padding:2px;border-top: solid 1px #000000; padding:2px"><?php  
		   if(@$part_item_details_hss[$r]['item_code']==$item_code[$j]){ echo @$part_item_details_hss[$r]['admn_no'];} ?></td>
           <td height="20" bgcolor="#FFFFFF" style="width:5%;border-top: solid 1px #000000; padding:2px"><?php 
