<?php echo form_open('user/admin_users/add_admin', array('id' => 'formUser','name' => 'formUser'));
?>
               ...
               <tr>
                ...
                <td align="left" width="55%" class="table_row_first">
					<div class="float_left">
						...
						<?php 
						echo form_dropdown("cmbSubDistrict", $subdistricts, @$selected_user[0]['sub_district_code'], 'id="cmbSubDistrict" class="input_box"  ');
						//onChange="javascript:loadSchool()"
						?>
						</div>
					</div>
