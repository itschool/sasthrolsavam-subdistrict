  ...
  <tr>
    <td align="left" colspan="5">
      	<div style="float:left;" id="divDistrict" >
			...
			echo form_dropdown("userTypeFilter", $user_types, @$_POST['userTypeFilter'], 'id="userTypeFilters"  onChange="javascript:loadDistrictFilter()"');
			?>
           </div>  
        <div style="float:left; padding-left:8px; display:<?php echo (isset($_POST['cmbDistrictFilter']) && trim($_POST['cmbDistrictFilter']) != 0)? 'block' : 'none';?>" id="divDistrictFilter">
            ...
            echo form_dropdown("cmbDistrictFilter", $states, @$_POST['cmbDistrictFilter'], 'id="cmbDistrictFilters"   onChange="javascript:loadSubDistrictFilter()"');
            ?>
    	</div> 
...
<input type="hidden" name="cmbSchoolFilter" id="cmbSchoolFilter" value="<?php echo @$_POST['cmbSchoolFilter']?>" />
  ...
  <tr>
    <th align="center" width="8%" class="table_row_first">Sl.No.</th>
    <th align="left"  width="25%"  class="table_row_first">User Name</th>
    <th align="left"  width="22%"  class="table_row_first">Generated Password</th>
    <th align="left" width="27%"  class="table_row_first">User Type</th>
    <th align="center" width="8%"  class="table_row_first">Edit</th>
