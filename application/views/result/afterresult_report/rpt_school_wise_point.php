...
<table width="100%" border="0" align="center">
        <tr>
            <td  align="center" class="style1"><?php echo $fairname; ?> Item Wise Point Report</td>
        </tr>
...
<table width="93%" border="1" align="center" cellpadding="0" cellspacing="0">
	...
	$previous=$data['fest_name'];
	 ...
	 <tr>
        ...
        <td colspan="2" align="right" style=' height:20px;'>Total  :&nbsp;</td>
...
<tr>
      ...
      <td width="30" align="center" style='border: 0 0 0.5px 0.5px 0 #000000;  height:20px;'><?php if($fairid==4)echo 'Total Mark';else echo 'P'; ?></td>
    </tr>
		   <?php 
           }
    ...
    <tr>
		...
		$itemlength = strlen($data['item_code']);
